            ...
            <section className={styles.right}>
                ...
                <article className={styles.messages}>
                    <ChatMessage message="No to kurde jedziemyNo to kurde jedziemyNo to kurde jedziemy"
                                 ...
                                 author={false}/>
                    <ChatMessage
                        message="12 to kurde jedziemyNo to kurde jedziemyNo to kurde jedziemy12 to kurde jedziemyNo to kurde jedziemyNo to kurde jedziemy12 to kurde jedziemyNo to kurde jedziemyNo to kurde jedziemy12 to kurde jedziemyNo to kurde jedziemyNo to kurde jedziemy12 to kurde jedziemyNo to kurde jedziemyNo to kurde jedziemy12 to kurde jedziemyNo to kurde jedziemyNo to kurde jedziemy12 to kurde jedziemyNo to kurde jedziemyNo to kurde jedziemy"
                        seen={false}
                        date="12:30"
                        author={true}/>
                </article>
